...
import com.market.ecommerce.product.client.SellerServiceClient;
...
import com.market.ecommerce.exception.domain.product.ProductException;
import com.market.ecommerce.product.service.ProductImageService;
...
import static com.market.ecommerce.exception.domain.product.ProductErrorCode.PRODUCT_REGISTRATION_FAILED;
import static com.market.ecommerce.exception.domain.product.ProductErrorCode.PRODUCT_UPDATE_FAILED;
...
public class ProductApplication {
    ...
    public ProductRegister.Response registerProduct(
        ...
        Seller seller = sellerServiceClient.findSellerByUsername(username);
