...
import com.market.ecommerce.domain.user.mapper.UserMapper;
import com.market.ecommerce.domain.user.repository.UserRepository;
...
import static com.market.ecommerce.common.exception.user.UserErrorCode.USER_NOT_FOUND;
...
public class UserService {
    ...
    public SignUp.Response signUp(SignUp.Request req) {
        ...
        return SignUp.Response.fromEntity(user);
    }
