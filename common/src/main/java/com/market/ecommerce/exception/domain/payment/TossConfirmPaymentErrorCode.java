...
@Getter
@AllArgsConstructor
public enum TossConfirmPaymentErrorCode {
    ...
    NOT_FOUND_TERMINAL_ID(HttpStatus.BAD_REQUEST, "단말기번호가 없습니다. 토스페이먼츠로 문의 바랍니다."),
    ...
    FDS_ERROR(HttpStatus.FORBIDDEN, "[토스페이먼츠] 위험거래가 감지되어 결제가 제한됩니다. 문자 링크를 통해 본인인증 후 결제가 가능합니다."),
